#
# Be sure to run `pod lib lint NgFramework.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'NgFramework'
  s.version          = '0.1.0'
  s.summary          = 'A swift framework for experimenting with TDD programming.'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source_files = 'NgFramework/Classes/**/*'
  
  # s.resource_bundles = {
  #   'NgFramework' => ['NgFramework/Assets/*.png']
  # }
